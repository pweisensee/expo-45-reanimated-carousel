...
const SnapCarouselComplexComponent = React.lazy(() => import('./snap-carousel-complex'));
const SnapCarouselLoopComponent = React.lazy(() => import('./snap-carousel-loop'));
            ...
            <View flex>
                <NavigationContainer>
                        ...
                        screenOptions={{
                            ...
                            headerRight: ({ tintColor }) => (
                                <View row centerV>
                                    ...
                                    >
                                        <Text color={tintColor}>{isRTL ? 'LTR' : 'RTL'}</Text>
                                    </TouchableWithoutFeedback>
                                </View>
                            ),
                        }}
                    >
                        ...
                        <Stack.Screen name="ParallaxLayers" component={ParallaxLayers} />
                        ...
                        />
                        <Stack.Screen name="ScaleFadeInOut" component={ScaleFadeInOutComponent} />
                        <Stack.Screen name="RotateInOut" component={RotateInOutComponent} />
                        <Stack.Screen
                            name="RotateScaleFadeInOut"
                            component={RotateScaleFadeInOutComponent}
                        />
                        <Stack.Screen name="AnimTabBar" component={AnimTabBarComponent} />
                        <Stack.Screen name="Marquee" component={MarqueeComponent} />
                        <Stack.Screen name="Multiple" component={MultipleComponent} />
